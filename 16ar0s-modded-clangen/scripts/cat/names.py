...
class Name():
    ...
    normal_suffixes = [  # common suffixes
        ...
        # regular suffixes
        "acorn", "ash", "aster", "back", "beam", "bee", "belly", "berry", "bite", "bird", "blaze", "blink", "bringer",
        "blossom", "bloom", "blotch", "bounce", "branch", "breeze", "briar", "bright", "brook", "burr", "bush", "bring",
        ...
        "fish", "flame", "flight", "flood", "flower", "frost", "gaze", "goose", "gorse", "grass", "ghost", "hail", "hare", 
        "hawk", "haze", "heath", "heather", "holly", "hollow", "ivy", "jaw", "jay", "jump", "kite",
        "lake", "larch", "leaf", "leap", "leg", "light", "lilac", "lily", "lotus", "misty", "mask", "mist", "moth",
        "moon", "mouse", "needle", "nettle", "night", "noise", "nose", "nut", "pad", "path", "patch",
        "paws", "petal", "pond", "pool", "poppy", "pounce", "puddle", "rapid", "rose", "rump", "run", "runner",
        ...
        "tail", "talon", "tree", "throat", "tooth", "tuft", "watcher", "watch", "water", "whisper", "willow", "wind", "wing", "wish"
    ]
    ...
    normal_prefixes = [
        ...
        'Barley', 'Barley', 'Basil', 'Bass', 'Bat', 'Bay', 'Bayou', 'Beam', 'Black',
        'Bear', 'Beaver', 'Bee', 'Beech', 'Beetle', 'Berry', 'Big', 'Birch', 'Blizzard',
        'Bird', 'Bite', 'Bitter', 'Bittern', 'Blaze', 'Bleak', 'Blight', 'Blue',
        'Blink', 'Bliss', 'Bloom', 'Blossom', 'Blotch', 'Bluff', 'Bog', 'Bog', 'Bud',
        'Bold', 'Borage', 'Bough', 'Boulder', 'Bounce', 'Bracken', 'Bramble', 'Brown',
        'Branch', 'Brave', 'Breeze', 'Breeze', 'Briar', 'Bright', 'Brindle', 'Bushy',
        'Bristle', 'Broken', 'Brook', 'Brush', 'Bubble', 'Bubbling', 'Buck',
        'Bug', 'Bumble', 'Burdock', 'Burn', 'Burnt', 'Burr', 'Bush', 'Buzzard', 'Clouded',
        'Carp', 'Cedar', 'Cedar', 'Chaffinch', 'Char', 'Cheetah', 'Cherry', 'Cloudy',
        'Chestnut', 'Chive', 'Cicada', 'Cinder', 'Cinnamon', 'Claw', 'Clay', 'Crook',
        ...
        'Curly', 'Cypress', 'Dahlia', 'Daisy', 'Damp', 'Dapple', 'Dappled', 'Darkened',
        'Dark', 'Dawn', 'Dawn', 'Day', 'Dead', 'Deer', 'Dew', 'Doe', 'Dog',
        'Dove', 'Down', 'Downy', 'Drake', 'Drift', 'Drizzle', 'Drought', 'Dry',
        'Duck', 'Dull', 'Dune', 'Dusk', 'Dust', 'Eagle', 'Echo', 'Eel', 'Ebony',
        'Egret', 'Elk', 'Elm', 'Ember', 'Ever', 'Ermine', 'Faded', 'Faded', 'Fading',
        'Falcon', 'Fallen', 'Fallen', 'Fallow', 'Fawn', 'Feather', 'Fennel',
        'Fern', 'Ferret', 'Fidget', 'Fierce', 'Fin', 'Finch', 'Fir', 'Fish',
        'Flail', 'Flame', 'Flash', 'Flax', 'Fleck', 'Fleet', 'Flicker', 'Fire',
        'Flight', 'Flint', 'Flip', 'Flood', 'Flood', 'Flower', 'Flower',
        'Flurry', 'Flutter', 'Fly', 'Foam', 'Forest', 'Fox', 'Freckle', 'Furze',
        'Freeze', 'Fringe', 'Frog', 'Frond', 'Frost', 'Frozen', 'Furled',
        'Fuzzy', 'Gander', 'Gannet', 'Gem', 'Giant', 'Gill', 'Gleam', 'Glow', 'Green',
        'Goose', 'Gorge', 'Gorse', 'Grass', 'Gravel', 'Grouse', 'Gull', 'Gust', 'Gale',
        'Gold', 'Golden', 'Gray', 'Hail', 'Half', 'Hare', 'Harvest', 'Hatch', 'Hawk', 'Hay', 'Haze',
        'Heath', 'Heather', 'Heavy', 'Hedge', 'Hen', 'Heron', 'Hickory',
        'Hill', 'Hoarse', 'Hollow', 'Holly', 'Hoot', 'Hop', 'Hope', 'Hornet',
        'Hound', 'Hazel', 'Honey', 'Ice', 'Icy', 'Iris', 'Ivy', 'Jagged', 'Jasper', 'Jay', 'Jet',
        ...
        'Log', 'Long', 'Lost', 'Lotus', 'Loud', 'Low', 'Lynx', 'Lion', 'Maggot', 'Memory',
        'Mallow', 'Mantis', 'Maple', 'Marigold', 'Marsh', 'Marten', 'Meadow', 'Memory',
        'Mellow', 'Merry', 'Midge', 'Milk', 'Mink', 'Minnow', 'Mint', 'Mist',
        'Mistle', 'Misty', 'Mite', 'Mock', 'Mole', 'Mole', 'Moon', 'Moor', 'Magnolia',
        'Morning', 'Moss', 'Mossy', 'Moth', 'Moth', 'Mottle', 'Mottled', 'Mouth',
        'Mouse', 'Mouse', 'Mud', 'Mumble', 'Murk', 'Nacre', 'Narrow', 'Nectar',
        'Needle', 'Nettle', 'Newt', 'Night', 'Nut', 'Oak', 'Oat', 'Odd', 'One',
        'Orange', 'Osprey', 'Otter', 'Owl', 'Olive', 'Pale', 'Pansy', 'Panther',
        ...
        'Quick', 'Quiet', 'Quill', 'Rabbit', 'Raccoon', 'Ragged', 'Rain', 'Red',
        'Rambling', 'Rat', 'Rattle', 'Raven', 'Reed', 'Ridge', 'Rift', 'Russet',
        'Ripple', 'River', 'Roach', 'Robin', 'Rock', 'Rook', 'Root', 'Rose',
        'Rosy', 'Rot', 'Rowan', 'Rubble', 'Running', 'Rush', 'Rust', 'Rye',
        'Sage', 'Sandy', 'Scar', 'Scorch', 'Sea', 'Sedge', 'Seed', 'Shade', 'Sand',
        'Shard', 'Sharp', 'Shell', 'Shimmer', 'Short', 'Shrew', 'Shy', 'Silk', 'Snow',
        'Silt', 'Skip', 'Sky', 'Slate', 'Sleek', 'Sleet', 'Slight', 'Sloe', 'Silver',
        'Slope', 'Small', 'Smoke', 'Smoky', 'Snail', 'Snake', 'Snap', 'Sneeze',
        'Snip', 'Soft', 'Song', 'Soot', 'Sorrel', 'Spark', 'Sparrow', 'Sheep', 'Shred',
        'Speckle', 'Spider', 'Spike', 'Spire', 'Splash', 'Spotted', 'Spring', 'Shining',
        'Spruce', 'Squirrel', 'Stag', 'Starling', 'Steam', 'Stoat', 'Stone', 'Stumpy',
        'Stork', 'Storm', 'Stream', 'Strike', 'Stump', 'Swallow', 'Swamp', 'Sun', 'Sunny',
        'Swan', 'Sweet', 'Swift', 'Tall', 'Talon', 'Thistle', 'Thorn', 'Tangle', 'Thrush',
        'Thrift', 'Thyme', 'Tiger', 'Timber', 'Tip', 'Toad', 'Torn', 'Trout', 'Tiny',
        'Tuft', 'Tulip', 'Tumble', 'Turtle', 'Twig', 'Uinta', 'Vine', 'Violet', 'Vixen',
        'Vole', 'Warm', 'Wasp', 'Weasel', 'Web', 'Wet', 'Wheat', 'Whirl', 'Weed',
        'Whisker', 'Wild', 'Willow', 'Wind', 'Windy', 'Wisteria', 'Wolf', 'Wood', 'White',
        'Wren', 'Weep', 'Weeping', 'Yarrow', 'Yellow', 'Yew', 'Zinnia', 'Zephyr',
    ]
