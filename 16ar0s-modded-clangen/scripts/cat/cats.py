...
class Cat():
    ...
    personality_groups = {
        'Outgoing': ['adventurous', 'bold', 'charismatic', 'childish', 'confident', 'daring',
                        'playful', 'righteous', 'attention-seeker', 'bouncy', 'noisy', 'charming',],
    ...
    skills = [
        'good hunter', 'great hunter', 'skillful hunter', 'extraordinary hunter', 'smart',
        'very smart', 'extremely smart', 'prodigy', 'good fighter', 'great fighter',
        'excellent fighter', 'good speaker', 'great speaker',
        'excellent speaker', 'strong connection to StarClan', 'good teacher',
        'great teacher', 'fantastic teacher', 'good tracker', 'great tracker',
        'excellent tracker', 'strong connection to the Dark Forest',
        'weak connection to StarClan', 'gatherer', 'good gatherer', 
        'very good gatherer', 'extremely good gatherer', 'good swimmer',
        'great swimmer', 'excellent swimmer', 'good climber', 'great climber',
        'fantastic climber', 'good runner' , 'great runner', 'fantastic runner',
        'tunneler', 'experienced tunneler', 'weak connection to StarClan',
        'weak connection to the Dark Forest', 'great sense of hearing', 'strategist'
    ]
    med_skills = [
        ...
        'smart', 'very smart', 'extremely smart', 'prodigy', 'good mediator',
        'great mediator', 'excellent mediator', 'clairvoyant', 'prophet',
        'gatherer', 'good gatherer', 'very good gatherer', 'extremely good gatherer', 
        'botanist', 'weak connection to Dark Forest', 'weak connection to StarClan'
    ]
    elder_skills = [
        ...
        'strong connection to StarClan', 'smart', 'very smart', 'extremely smart', 'prodigy'
        'good kitsitter', 'great kitsitter', 'excellent kitsitter', 'camp keeper', 'den builder',
        'weak connection to StarClan', 'weak connection to Dark Forest'
    ]

    skill_groups = {
        'special': ['omen sight', 'dream walker', 'clairvoyant', 'prophet', 'lore keeper', 'keen eye', 'botanist'],
        'star': ['strong connection to StarClan', 'weak connection to StarClan'],
        'dark': ['strong connection to Dark Forest', 'weak connection to Dark Forest'],
        ...
        'smart': ['smart', 'very smart', 'extremely smart', 'prodigy'],
        'hunt': ['good hunter', 'great hunter', 'skillful hunter', 'extraordinary hunter'],
        'swim': ['good swimmer', 'great swimmer', 'excellent swimmer'],
        'run': ['good runner', 'great runner', 'fantastic runner'],
        'dig': ['tunneler', 'experienced tunneler'],
        'climb': ['good climber', 'great climber', 'fantastic climber'],
        'gather': ['gatherer', 'good gatherer', 'very good gatherer', 'extremely good gatherer'],
        'track': ['great sense of hearing', 'good tracker', 'great tracker', 'excellent tracker'],
        'fight': ['good fighter', 'great fighter', 'excellent fighter', 'strategist'],
    ...
    backstories = [
        'clanborn', 'half-clan1', 'half-clan2', 'outsider_roots1', 'outsider_roots2', 'outsider_roots3',
        'loner1', 'loner2', 'kittypet1', 'kittypet2', 'kittypet3', 'rogue1', 'rogue2', 'abandoned1',
        'abandoned2', 'abandoned3', 'abandoned4', 'otherclan', 'otherclan2', 'ostracized_warrior', 
        'disgraced', 'retired_leader', 'refugee', 'tragedy_survivor', 'clan_founder', 'cave', 'framed_exile',
        'wanderer1', 'wanderer2', 'wanderer3', 'wanderer4', 'wanderer5', 'medicine_cat1', 'medicine_cat2'
    ]
    ...
    def __init__(self,
        ...
        #trans cat chances
        trans_chance = randint(0, 10)
        nb_chance = randint(0, 15)
    ...
    def update_skill(self):
        ...
        if self.skill == '???':
            ...
            if self.status == 'medicine cat' and self.skill not in self.med_skills:
                ...
                possible_groups = ['special', 'heal', 'star', 'mediate', 'smart', 'teach', 'gather', 'track']
            ...
            # assign skill to new warrior
                ...
                possible_groups = ['star', 'smart', 'teach', 'hunt', 'fight', 'speak', 'dig', 'track', 'gather', 'swim', 'run', 'climb', ]
                # check if they had a mentor
                if self.former_mentor:
...
# ---------------------------------------------------------------------------- #
    def is_potential_mate(self, other_cat, for_love_interest = False, former_mentor_setting = game.settings['romantic with former mentor']):
        ...
        # check for age
        if (self.moons < 12 or other_cat.moons < 12) and not for_love_interest:
            return False
...
# ---------------------------------------------------------------------------- #
    ...
    def experience(self, exp):
        ...
        experience_levels = [
            'beginner', 'amateur', 'novice', 'initiate', 'adept',
            'expert', 'knowledgeable', 'master', 'sage'
        ]
