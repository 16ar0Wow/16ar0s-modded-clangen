...
class InfoScreen(Screens):
    ...
    def on_use(self):
        ...
        verdana.text("Welcome to Warrior Cats clan generator; Modded Edition!",
                     ('center', 160))
        verdana.text(
            "This was originally a fan-made generator which has now been modded by 16ar0",
            ('center', 205))
        verdana.text(
            "inspired from the Warrior Cats-book series by Erin Hunter.",
            ('center', 225))
        verdana.text(
            "For the general purpose of the game; Create a new clan with the 'New Clan' button, and choose",
            ('center', 265))
        verdana.text(
            "4-7 cats to start with. A total of 8 clans can be saved and revisited freely.",
            ('center', 285))
        verdana.text(
            "If you go over that number then the oldest save will be overwritten.",
            ('center', 305))
        verdana.text(
            "You're free to use non-modded sprites generated from this program, though please",
            ('center', 345))
        verdana.text(
            "do not use sprites generated by the mod for non-personal use such as selling or claiming as your own.",
            ('center', 365))
        verdana.text("Original creator: just-some-cat.tumblr.com",
                     ('center', 415))
        verdana.text("Fan edit made by: SableSteel; Modded edit made by 16ar0.", ('center', 445))

        verdana.text("Thank you for playing! I hope you enjoy this version.", ('center', 550))
