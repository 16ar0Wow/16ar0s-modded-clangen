...
def bs_blurb_text(cat, backstory=None):
    ...
    if backstory == 'outsider_roots3':
        bs_blurb = "This cat was born outside the clan, though was brought her with one of their parents after escaping " \
                   "an evil leader\'s rule."
    if backstory == 'loner1':
    ...
    if backstory == 'kittypet3':
        bs_blurb = "This cat lived with wealthy twolegs before being abandoned and later stumbled upon this clan."
    if backstory == 'rogue1':
    ...
    if backstory == 'abandoned4':
        bs_blurb = "This cat's mother died to a fox while hunting. Luckily enough they were found by a border " \
                   "patrol, later being taken in by the clan."
    if backstory == 'medicine_cat1':
    ...
    if backstory == 'cave':
        bs_blurb = "This cat arrived at the clan after living their whole life in a cave."
    ...
    if backstory == 'framed_exile':
        bs_blurb = "This cat was accused by another cat from their original clan before being exiled. " \
                   "They later found themselves joining this clan for safety and shelter."
    if backstory == 'wanderer1':
        bs_blurb = "This cat lived in a recently contaminated environment before escaping into this " \
                   "clan's territory, later finding themselves joining it."
    if backstory == 'wanderer2':
        bs_blurb = "This cat tried their very best to survive in a ill-ridden environment before eventually " \
                   "deciding to travel elsewhere. They later stumbled upon this clan by accident."
    if backstory == 'wanderer3':
        bs_blurb = "This cat's whole life was shaped around finding a new home, traveling for moons on end " \
                   "until they finally found this clan."
    if backstory == 'wanderer4':
        bs_blurb = "This cat wandered far from their original home for entertainment before becoming interested " \
                   "in the idea of being a clan cat after learning of them."
    if backstory == 'wanderer5':
        bs_blurb = "This cat once promised themselves they would never again stay in one area for more then 2 " \
                   "moons until they found a best friend in a clan from this clan."
    return bs_blurb
...
def backstory_text(cat):
    ...
    elif bs_display in ['outsider_roots1', 'outsider_roots2', 'outsider_roots3']:
        bs_display = 'outsider roots'
    elif bs_display in ['loner1', 'loner2']:
        bs_display = 'formerly a loner'
    elif bs_display in ['kittypet1', 'kittypet2', 'kittypet3']:
    ...
    elif bs_display == 'cave':
        bs_display = 'cave'
    elif bs_display == 'framed_exile':
        bs_display = 'wrongly exiled'
    elif bs_display == 'wanderer1':
        bs_display = 'contaminated home'
    elif bs_display == 'wanderer2':
        bs_display = 'contaminated home'
    elif bs_display == 'wanderer3':
        bs_display = 'wanderer from afar'
    elif bs_display == 'wanderer4':
        bs_display = 'wanderer from afar'
    elif bs_display == 'wanderer5':
        bs_display = 'nomad'
    if bs_display == None:
        bs_display = None
    else:
        ...
        if game.switches['profile_tab_group'] == 'backstory':
            ...
            if game.switches['sub_tab_group'] == 'relation sub tab':
                ...
                if influenced_skill in Cat.skill_groups.get('special'):
                    ...
                    become_group = ['heal', 'teach', 'mediate', 'hunt', 'fight', 'speak', 'swim', 'dig', 'climb', 'run', 'gather', 'track']
